      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Leading Africa's transition to smart, sustainable infrastructure through innovation in energy, cloud, and
              environmental technologies.
            </p>
            <div className="flex space-x-4">
              <Button variant="ghost" size="icon" className="text-gray-400 hover:text-white hover:bg-teal-600">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services#energy" className="text-gray-300 hover:text-teal-400 transition-colors">
                  Energy & Electrical
                </Link>
              </li>
              <li>
                <Link href="/services#network" className="text-gray-300 hover:text-teal-400 transition-colors">
                  IT Network Engineering
                </Link>
              </li>
              <li>
                <Link href="/services#cloud" className="text-gray-300 hover:text-teal-400 transition-colors">
                  Cloud Solutions
                </Link>
              </li>
              <li>
                <Link href="/services#environmental" className="text-gray-300 hover:text-teal-400 transition-colors">
                  Environmental Tech
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">info@orianxresources.com</span>
              </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} Orianx Resources Limited. All rights reserved.
          </p>
